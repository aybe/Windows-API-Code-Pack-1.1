...
namespace D3D10Tutorial06_WinFormsControl
{
    ...
    public class Cube
    {
        ...
        public class CubeVertices
        {
            ...
            {
                new SimpleVertex() { Pos = new Vector3F ( -1.0f, 1.0f, -1.0f ), Normal = new Vector3F ( 0.0f, 1.0f, 0.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( 1.0f, 1.0f, -1.0f ), Normal = new Vector3F ( 0.0f, 1.0f, 0.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( 1.0f, 1.0f, 1.0f ), Normal = new Vector3F ( 0.0f, 1.0f, 0.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( -1.0f, 1.0f, 1.0f ), Normal = new Vector3F ( 0.0f, 1.0f, 0.0f ) },
                ...
                new SimpleVertex() { Pos = new Vector3F ( -1.0f, -1.0f, 1.0f ), Normal = new Vector3F ( -1.0f, 0.0f, 0.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( -1.0f, -1.0f, -1.0f ), Normal = new Vector3F ( -1.0f, 0.0f, 0.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( -1.0f, 1.0f, -1.0f ), Normal = new Vector3F ( -1.0f, 0.0f, 0.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( -1.0f, 1.0f, 1.0f ), Normal = new Vector3F ( -1.0f, 0.0f, 0.0f ) },
                ...
                new SimpleVertex() { Pos = new Vector3F ( -1.0f, -1.0f, -1.0f ), Normal = new Vector3F ( 0.0f, 0.0f, -1.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( 1.0f, -1.0f, -1.0f ), Normal = new Vector3F ( 0.0f, 0.0f, -1.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( 1.0f, 1.0f, -1.0f ), Normal = new Vector3F ( 0.0f, 0.0f, -1.0f ) },
                new SimpleVertex() { Pos = new Vector3F ( -1.0f, 1.0f, -1.0f ), Normal = new Vector3F ( 0.0f, 0.0f, -1.0f ) },
