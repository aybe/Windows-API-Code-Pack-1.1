...
using namespace System;
    ...
    public: 
        ...
        {
            Direct3D11::CounterType get(void) { return type; }
        }
    ...
    internal:
        ...
        CounterData(Direct3D11::CounterType type, int activeCounterCount, String^ name, String^ units, String^ description)
        {
            this->type = type;
